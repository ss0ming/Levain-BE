...
public class PageResponseDTO<E> {
    ...
    private PageReqDTO pageRequestDTO;

    private boolean prev, next;

    private int totalCount, prevPage, nextPage, totalPage;

    @Builder(builderMethodName = "withAll")
    public PageResponseDTO(List<E> dtoList, PageReqDTO pageRequestDTO, long total) {
